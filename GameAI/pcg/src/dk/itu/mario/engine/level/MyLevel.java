...
public class MyLevel extends Level{
	...
	public void create(MyDNA dna, int type) {
        ...
        String genotype = dna.getChromosome();
        for (int x = STARTOFFSET; x < EXITOFFSET; x++) {
            this.setBlock(x, DEFAULTHEIGHT - 2, HILL_TOP);
            this.setBlock(x, DEFAULTHEIGHT - 1, GROUND);
        }
        ...
        for (int i = 0; i < genotype.length(); i++) {
            char l = genotype.charAt(i);
            if (l == 'u') {
                //coin profile
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-5, COIN);
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-4, COIN);
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-3, COIN);
            } else if (l == 'k') {
                //climber/jumper profile
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-5, ROCK);
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-4, ROCK);
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-3, ROCK);
            } else if (l == 'a' || l == 'v' || l == 't') {
                //killer profile
                this.setSpriteTemplate(STARTOFFSET + i, DEFAULTHEIGHT-3, new SpriteTemplate(1, false));
                this.setSpriteTemplate(STARTOFFSET + i, DEFAULTHEIGHT-3, new SpriteTemplate(2, false));
                this.setSpriteTemplate(STARTOFFSET + i, DEFAULTHEIGHT-4, new SpriteTemplate(4, true));
                this.setSpriteTemplate(STARTOFFSET + i, DEFAULTHEIGHT-4, new SpriteTemplate(5, true));
            }
            else if (l == 'n'|| l == 'i') {
                //hybrid coin and killer
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-5, COIN);
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-4, COIN);
                this.setBlock(STARTOFFSET + i, DEFAULTHEIGHT-3, COIN);
                this.setSpriteTemplate(STARTOFFSET + i, DEFAULTHEIGHT-3, new SpriteTemplate(4, true));
                this.setSpriteTemplate(STARTOFFSET + i, DEFAULTHEIGHT-3, new SpriteTemplate(5, true));
            }

//
//            this.setBlock(50, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(50, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(127, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(127, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(30, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(30, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(184, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(184, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(84, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(84, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(71, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(71, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(45, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(45, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(93, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(93, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(29, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(29, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(40, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(40, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(43, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(43, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(26, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(26, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(69, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(69, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(43, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(43, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(56, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(56, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(26, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(26, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(147, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(147, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(156, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(156, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(104, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(104, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(112, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(112, DEFAULTHEIGHT-5, ROCK);
//
//            this.setBlock(197, DEFAULTHEIGHT-7, COIN);
//            this.setBlock(197, DEFAULTHEIGHT-5, ROCK);
